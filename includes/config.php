...

{
...

	{
		...
		define('DATABASE', 'rainend_stagsource.com');
...

	{
...

		{
			...
			define('DATABASE', 'stagsource_demo');

			define('USERNAME', 'stagdemo');

			define('PASSWORD', 'EnLO*kVG~z32');
...
require DIR_LIBRARY.'facebook-sdk/src/facebook.php';
...
$facebook = new Facebook(array(
  'appId'  => '1432385133687864',
  'secret' => '614a96d615831911c9c78ac4c17adcc7',
  //'cookie' => true
));
...
define('FBOBJECT', serialize($facebook));
define('TWITER_CONSUMERKEY', 'JPwiLouxzGfDApCCTo9zVA');
define('TWITER_CONSUMERSECRET', 'ZDDw6z7XTxhfyTL79vVUCXcfPGnss0jUfjGLjNqTus');
define('TWITER_ACCESSTOKEN', '91552323-FeYSocxrXhtXk7XBj5MCtF9LBFfKKwuzYD2lhgmof');
define('TWITER_ACCESSTOKENSECRET', '5F4YM9mzZbmlcqjWwTGqYCEoibcD4xf3Ah1Kr5oM');
