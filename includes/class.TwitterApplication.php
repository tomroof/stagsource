...
class TwitterApplication
{
     ...
     *    Oauth.php
     *
     *    Created by Vladbbk on 2013-03-20.
     *
     */
    ...
    public function get_bearer_token()
    {
        ...
        //$encoded_consumer_key = urlencode(Yii::app()->params['twitter']['consumerKey']);
       // $encoded_consumer_secret = urlencode(Yii::app()->params['twitter']['consumerSecret']);
	   
	   $encoded_consumer_key = urlencode(TWITER_CONSUMERKEY);
       $encoded_consumer_secret = urlencode(TWITER_CONSUMERSECRET);
     ...
     */
    public function search_for_a_term($bearer_token, $query, $result_type = 'mixed', $count = '15')
    {
    ...
    public function  getDataTweetById($id)
    {
