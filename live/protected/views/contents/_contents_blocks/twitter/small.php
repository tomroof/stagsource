<div class="content-block twitter-block">
    <div class="content-block-wrap">
    <p class="author"><?php echo Functions::getPrewText($data->content_title) ?>: </p>
    <a href="<?php echo $data->content_source ?>" title="" target="_blank"><?php echo (mb_strlen($data->content_content)<120)?$data->content_content:substr($data->content_content, 0 , 120) . '...' ;?></a>
