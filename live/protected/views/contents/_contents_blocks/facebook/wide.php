<div class="content-block fb-block-wide">
    <div class="content-block-wrap">
    <p class="author"><?php echo Functions::getPrewText($data->content_title) ;?>: </p>
    <a href="<?= $data->content_facebook_link ?>" target="_blank" title=""><?php echo (mb_strlen($data->content_content)<250)?$data->content_content:substr($data->content_content, 0 , 250) . '...' ;?></a>
