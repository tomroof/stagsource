<div class="content-block article-block-wide">
    <div class="content-block-wrap">
    <div class="img-wrap">
        <a href="<?= $data->permalink ?>" title="">
            <?php echo $data->getContentImage(Contents::SIZE_IMAGE_508x250, $data->content_thumbnail,Contents::DEFAULT_IMAGE_WIDE); ?>
        </a>
    </div>
    ...
    <div class="bot-block">
        ...
        <div class="bot-block-in2">
            <p><?php echo User::getUserFullNameById($data->content_author); ?></p>
