    ...
    <div class="details-main-block <?php echo (empty($prevModel)) ? 'left-empty' : ''; ?>">
        <div class="wrap">
            ...
            <div class="center-content-block">
                ...
                <?php endif; ?>
                <div class="content-block video-block-big">
                    <div class="video-block-in">
                        <a href="<?= $content->permalink ?>" title="">
                            <?php echo Contents::getContentVideoSizeLink($content->content_video_embed, Contents::VIDEO_SIZE_508x508); ?>
                        </a>
                    </div>
                    <div class="video-block-bot"><a href="<?= $content->permalink ?>"><?php echo $content->content_title ?></a></div> 
                </div>
