    ...
    <div class="details-main-block <?php echo (empty($prevModel)) ? 'left-empty' : ''; ?>">
        <div class="wrap">
            ...
            <div class="center-content-block">
                ...
                <?php endif; ?>
                <div class="content-block article-block-big product">
                    <div class="content-block-wrap">
                        <div class="img-wrap">
                            <a href="<?= $content->permalink ?>" title="">
                                <?php echo $content->getContentImage(Contents::SIZE_IMAGE_508x508, $content->content_thumbnail,Contents::DEFAULT_IMAGE_BIG); ?>
                            </a>
                        </div>
                        <div class="bot-block">
                            <b><a href="<?= $content->permalink ?>" title=""><?php echo Functions::getPrewText($content->content_title) ?></a></b>
                            <div class="price-product">$<?php echo (!empty($content->product_price)? $content->product_price : '0.00'); ?></div>
                            <p><?php echo Functions::getPrewText($content->content_content, 120) ?></p>
                        </div>
                        <?php if(!empty($content->content_source)){ ?>
                            <a class="but-big but-green" target="_blank" href="<?php echo $content->content_source; ?>">Buy now</a>
                        <?php } ?>
                    </div>
    ...
    <div class="wrap">
        <div class="block-content-in">
            ...
            if (!Yii::app()->user->isGuest) {
                                ...
                                <td>
                                    <div class="block-comment-gray">
                                        ...
                                        <p class="label text-3">
                                            ...
                                            <button class="but-big but-red"
                                                    onclick="jQuery('#comments-form').submit()">Submit
                                            </button>
                                        </p>
                ...
                ?>
                <span class="span_comment_sign_up">TO LEAVE A COMMENT, <a class="link_comment_sign_up" href="#header">SIGN
                        UP</a> NOW</span>
            <?php } ?>
        </div>
    </div>
