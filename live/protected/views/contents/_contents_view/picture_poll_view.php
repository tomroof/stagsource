    ...
    <div class="details-main-block <?php echo (empty($prevModel)) ? 'left-empty' : ''; ?>">
        <div class="wrap">
            ...
            <div class="center-content-block">
                ...
                <div class="content-block picture-poll-block-big">
                    <div class="content-block-wrap">
                        <p class="ttl"><?php echo $content->content_title ?></p>
                        <?php
                        $this->widget('webroot.protected.modules.poll.components.widgets.PollWidgetfrontend', array('model' => $content, 'return_url' => $content->permalink,
                            'view' => '_pollfrontend_img_result',
                            'submit' => false,
                        ));
                        ?>
                    </div>
