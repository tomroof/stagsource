                ...
                <div class="content-block article-block-big">
                    ...
                    <div class="bot-block">
                        <div class="bot-block-in1">
                            <?php echo Functions::getPrewText($content->content_title, 50) ?>
                        </div>
                        <div class="bot-block-in2">
                            <p><?php echo $content->user_rel->getUserFullNameByModel(); ?></p>

                            <p><?php echo Functions::getDateUSA($content->created_at); ?></p>
                        </div>
                    </div>
