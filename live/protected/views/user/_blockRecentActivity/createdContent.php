            ...
            <td>
                <div class="block-comment-gray">
                    ...
                    <div class="block-comment-top">
                        <p><b><a href="<?php echo Yii::app()->createUrl('user/publicProfile/' . $userModel->id); ?>"><?php echo User::getUserFullName($userModel) ?></a></b> created the topic <strong><a href="<?php echo $data->permalink; ?>"><?php echo $data->content_title ;?></a></strong></p>
                    </div>
