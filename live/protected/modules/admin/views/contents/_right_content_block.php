...
<div class="oneThree">
    <div class="widget">
        ...
        <div class="content">
            ...
            <?php
            if (!($model->content_type == Contents::TYPE_FACEBOOK ||  $model->content_type == Contents::TYPE_INSTAGRAM || $model->content_type == Contents::TYPE_TWITTER))
            ...
            <div class="row" >
                ...
                <?php echo CHtml::checkBox('content_is_premium_checkbox', ($model->content_is_premium != '1') ? false : true , array('id' => 'Contents_content_is_premium', 'value' => 0)); ?>
                
            </div>
            <div class="row">
                
                
                    <span id="content_is_premium_color_span" <?php echo ($model->content_is_premium != '1') ? 'style="display: none;"' : 'style="display: block;"' ?>>
                        <label>Color</label>
                        <div class="row-in">
