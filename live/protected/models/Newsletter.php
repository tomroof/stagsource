...
class Newsletter extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, email, active, date_subscription', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'email' => 'Enter Email ',
			'active' => 'Active',
			'date_subscription' => 'Date Subscription',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('date_subscription',$this->date_subscription,true);
