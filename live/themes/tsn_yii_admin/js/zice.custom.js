...
$('.searchAutocomplete').click(function() {
 ...
 function Processgraph(){
    ...
    $('.fileDialogPoll').live('focus',function(){
        var callback,input =$(this).attr('id');
        callback = $(this);
        var type=$(this).attr('title');
        fileDialogCallbackPoll(callback,type);
    })
    $('.fileDialogSettings').live('focus',function(){
        var callback = $(this);
//        var type=$(this).attr('title');
        fileDialogSettings(callback);
    })

    $('.fileDialogContentSlider').live('focus',function(){
        var callback = $(this);
//        var type=$(this).attr('title');
        fileDialogContentSlider(callback);
    })
...
//              console.log(callback,type,input);
			$('<div id="finder_'+callback+'"/>').elfinder({
				 url : '../../../../themes/tsn_yii_admin/components/elfinder/connectors/php/connector-'+type+'.php', editorCallback : function(url) { callback.val(url); callback.parent().prev().prev().html('<img  src="'+url+'"  width="180" alt="" />');
				},closeOnEditorCallback : true, dialog : { title : 'File manager',modal : true,width : 700 }
			})
	  }
          function fileDialogCallbackPoll(callback,type){
//              console.log(callback,type,input);
			$('<div id="finder_'+callback+'"/>').elfinder({
				 url : '../../../../themes/tsn_yii_admin/components/elfinder/connectors/php/connector-'+type+'.php', editorCallback : function(url) { callback.val(url); callback.parents('.block_callback').find('.block_callback_img').html('<img  src="'+url+'"  width="180" alt="" />');
				},closeOnEditorCallback : true, dialog : { title : 'File manager',modal : true,width : 700 }
			})
	  }
...
function fileDialogSettings(callback){
    $('<div id="finder_'+callback+'"/>').elfinder({
        url : '../../../../themes/tsn_yii_admin/components/elfinder/connectors/php/connector-fileimport.php', editorCallback :
            function(url) {
                callback.val(url);
                    console.log(callback.parents('.section').find('.img_show'));
                callback.parents('.section').find('.img_show').replaceWith('<img class="img_show" src="'+url+'"  width="80" height="80" alt="" />');
//                callback.val(url);
            },closeOnEditorCallback : true, dialog : { title : 'File manager',modal : true,width : 700 }
    })
}
function fileDialogContentSlider(callback){
    $('<div id="finder_'+callback+'"/>').elfinder({
        url : '../../../../themes/tsn_yii_admin/components/elfinder/connectors/php/connector-fileimport.php', editorCallback :
            function(url) {
                callback.val(url);
                    console.log(callback.parents('.section').find('.img_show'));
                callback.parents('.section').find('.img_show').replaceWith('<img class="img_show" src="'+url+'"  width="180" height="180" alt="" />');
//                callback.val(url);
            },closeOnEditorCallback : true, dialog : { title : 'File manager',modal : true,width : 700 }
    })
}
