...
;(function($) {
	...
	$.fn.twitterSearch.formatter = function(json, opts) {
		...
		str += '<div><span class="twitterSearchUser"><a href="http://www.twitter.com/'+ json.from_user+'/status/'+ json.id_str +'" target="_blank" >' 
	...
	$.fn.twitterSearch.defaults = {
		...
		css: {
			...
			container: { overflow: 'hidden', backgroundColor: 'none', height: '100%' },
			...
			tweet: { padding: '5px 4px 5px 0px', clear: 'left' },
			img:   { 'float': 'left', margin: '5px', width: '48px', height: '48px' },
			loading: { padding: '20px', textAlign: 'center', color: '#888' },
			text:  {},
			time:  { fontSize: 'smaller', color: '#671D2C' },
			title: { backgroundColor: '#fff', margin: 0, padding: '0 0 0px 0', textAlign: 'center', fontWeight: 'bold', fontSize: 'large', position: 'relative' },
