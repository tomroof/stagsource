        ...
        autoSuggest : function(options){
			...
			return this.each(function() {
...

									  {
...

										  {
											 ...
											 if(idHolder != "" && idHolder != null)
												...
												optionList += "<li><a href=\"javascript:void(0);\" id=\""+myId+"\">"+myText.toUpperCase()+"</a></li>";
												...
												optionList += "<li><a href=\"javascript:void(0);\">"+myText.toUpperCase()+"</a></li>";
				...
				$(".list li").live("click",function () {
					...
					if(idHolder != "" && idHolder != null)
					{
						var selected_value	= $("li[class='selected'] a").attr("id");
						//alert(idHolder);
						var selected_item = selected_value.split("~");

						//$("#"+idHolder).val($("li[class='selected'] a").attr("id"));
						$("#"+idHolder).val(selected_item[0]);
						$("#postcode_lat").val(selected_item[1]);
						$("#postcode_lng").val(selected_item[2]);
						
						ajax_check_postcode($('#postcode').val());
