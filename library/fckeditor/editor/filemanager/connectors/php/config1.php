...
//$Config['UserFilesPath'] = 'http://' . $_SERVER['SERVER_NAME'] . '/rainend/fallonbics.co.uk/userfiles/' ;
$Config['UserFilesPath'] = 'http://' . $_SERVER['SERVER_NAME'] . '/clients/necarpentry.co.uk/userfiles/' ;
...
//$Config['UserFilesAbsolutePath'] = $_SERVER['DOCUMENT_ROOT'] . '/rainend/fallonbics.co.uk/userfiles/';
$Config['UserFilesAbsolutePath'] = $_SERVER['DOCUMENT_ROOT'] . '/clients/necarpentry.co.uk/userfiles/';
