...
<div class="container">
   ...
   <!-- <form id="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">-->
    <form class="fileupload" action="#" method="POST" enctype="multipart/form-data" data-upload-template-id="template-upload-1"
	...
	<form class="fileupload" action="#" method="POST" enctype="multipart/form-data" data-upload-template-id="template-upload-2"
...
$(function () {
   ...
   /* $('#fileupload').fileupload({
		...
		$('#fileupload').bind('destroyed', function (e, data) {
			var files =data.result.files;
			var file = files[0];
			alert(file.name);
		});
