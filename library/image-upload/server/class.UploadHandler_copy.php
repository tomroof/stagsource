...
class UploadHandler
{
    ...
    function __construct($upload_folder = '',  $options = null, $initialize = true, $error_messages = null) {
	   
	    $this->upload_folder1 = $upload_folder;
		$this->category_id 	  = $_SESSION['cat_id'];
		
		$my					  = 'DIR_'.strtoupper($upload_folder);
		$my1				  = 'URI_'.strtoupper($upload_folder);
...
/*			'database' => 'image_upload',  
           ...
           // 'upload_url' => URI_ROOT. $upload_folder.'/', //$this->get_full_url().'/files/',
			'upload_dir' => constant($my), 
            'upload_url' => constant($my1), 
            'user_dirs' => false,
            'mkdir_mode' => 0755,
	...
	{  
	   /* if($this->upload_folder1 == 'image_gallery')
		{
		   $image_gallery				 = new image_gallery();
		   $image_gallery->image_category_id   = $category_id;
	...
	{  
		...
		{
		   $image_gallery				 		= new image_gallery();
		   $image_gallery->remove_by_image($this->category_id,$delimg );
		}
