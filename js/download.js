...
function open_category_details(category_download_id, serial_value)
...
{  
	...
	if(document.getElementById("show_category_download_id").value==0) {  document.getElementById("show_category_download_id").value=category_download_id;}

	var bid		= document.getElementById("show_category_download_id").value;

	//alert(bid+"   "+category_download_id);

	if(show=='0' && bid==category_download_id)
	...
	{		
		  ...
		  document.getElementById("show_category_download_id").value	= category_download_id;

	}

	else if(show=='0' && bid!=category_download_id)
	...
	else if(show=='1' && bid!=category_download_id)
	...
	var url="show_category_download_details.php?category_download_id="+category_download_id+"&category_serial_value="+serial_value+ "&show=" + show;
...
function change_download_status(download_id, selected_id)

{
	...
	var url="change_download_status.php";



	url = url+"?download_id=" + download_id;

	//alert(url);

	url = url+"&stid="+Math.random();

	xml_http_category.onreadystatechange	= change_status_onready;
...
function change_status_onready()
...
{ 
...

	{
...

		{
			...
			document.getElementById('status_text').innerHTML = category_status_text;
...
function change_menu_option(category_download_id, selected_id)

{

	if (category_download_id.length == 0)
	...
	url = url+"?category_download_id=" + category_download_id;
